...
class Morimori extends Works {
  constructor() {
    ...
    this.descriptions = [
      ...
      '筋肉専用プリクラ morimoriはこのような人々の承認欲求を満たしてくれる。筋肉の隆起に合わせて筋肉のコントラストやサイズ感を操作することで、筋肉の外形の特徴を損なうことなく自然なボリュームアップを実現し、筋肉そのままの魅力を引き出すことができる。',
