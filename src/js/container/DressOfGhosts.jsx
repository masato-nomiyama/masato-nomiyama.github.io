...
import Works, { worksStyle } from './Works'

const dressOfGhostsStyle = theme => {
  return {
    ...style,
    ...worksStyle(theme),
  }
...
class DressOfGhosts extends Works {
  constructor() {
    ...
    this.movie = 's8Q2XVtoIwU'
  }
}

export default withStyles(dressOfGhostsStyle)(DressOfGhosts)
